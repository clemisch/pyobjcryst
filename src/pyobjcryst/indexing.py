...
def quick_index(
    ...
    dmax = (
        pl.GetPeakList()[0].dobs / 10
    )  # assume there are no peaks at lower resolution
    if verbose:
        print(
        ...
        for csys in [
            ...
            if csys == CrystalSystem.CUBIC:
                ...
                vcen = [
                    ...
                    CrystalCentering.LATTICE_B,
                    CrystalCentering.LATTICE_C,
                    CrystalCentering.LATTICE_I,
                    CrystalCentering.LATTICE_F,
                ]
            ...
            for cent in vcen:
                ...
                if verbose:
                    print(
                        "%11s %c : V= %6.0f -> %6.0f A^3, max length=%6.2fA"
