...
# -*- coding: utf-8 -*-
#
# pyobjcryst documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("pyobjcryst")
except Exception:
...
modindex_common_prefix = ["pyobjcryst"]
...
basename = "pyobjcryst".replace(" ", "").replace(".", "")
