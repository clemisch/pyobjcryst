...
class TestMolecule(unittest.TestCase):
    ...
    def testContainment(self):
        """Make sure we can still use the molecule if the crystal is out
        of scope."""
        c = makeC60()
    ...
    def testAddPar(self):
        """See if we crash if we add a parameter and delete the
        molecule."""
        c = makeC60()
        m = self.c.GetScatterer("c60")
        rpt = RefParType("test")
    ...
    def testBonds(self):
        ...
        # is the bond still in existence?
        self.assertEqual(name, bond8.GetName())
    ...
    def testBondAngles(self):
        ...
        # is the object still in existence?
        self.assertEqual(name, ba8.GetName())
        # Can we get it from the engine?
